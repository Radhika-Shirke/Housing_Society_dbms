...
if($total!=0)
{
    while(($result=mysqli_fetch_array($data)))
    {
        ...
        <td><a href='update_wing_b.php?hid=$result[HID] & blockno=$result[BlockNo] & type=$result[House_Type] & owner=$result[Owner_Name] & details=$result[Details]'>Edit/Update </td>
        <td><a href='delete_wing_b.php?hid=$result[HID]' onclick='return checkdelete()'>Delete</td>
        ";
    }

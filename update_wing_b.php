...
$hid=$_GET['hid'];
$result=mysqli_query($con, "SELECT* from wing_b where HID=$hid");
...
if(Isset($_POST['update']))
{
    ...
    $result = mysqli_query($con, "UPDATE wing_b SET House_Type='$Type',Owner_Name='$Owner',Details='$Details' WHERE HID=$hid");

    if($result)
    {
        echo "<script>alert('Record Updated')</script>";
?>
<META HTTP-EQUIV="Refresh" CONTENT="0; URL=http://localhost/soc_mgmt/wing_b.php">
<?php
    }
    else
    {
...
if(isset($_GET['submit']))
{
    ...
    $query = "UPDATE wing_b set House_Type='$Type', Owner_Name='$Owner', Details='$Details' where HID='$Hid'";

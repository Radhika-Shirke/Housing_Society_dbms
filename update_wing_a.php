...
$hid=$_GET['hid'];
$result=mysqli_query($con, "SELECT* from wing_a where HID=$hid");
...
if(Isset($_POST['update']))
{
    ...
    $result = mysqli_query($con, "UPDATE wing_a SET House_Type='$Type',Owner_Name='$Owner',Details='$Details' WHERE HID=$hid");
...
if(isset($_GET['submit']))
{
    ...
    $query = "UPDATE wing_a set House_Type='$Type', Owner_Name='$Owner', Details='$Details' where HID='$Hid'";
